// Requantization unit: INT32 accumulator -> INT8 activation.
//
...
//
// Combinational. The 32x16 multiply would be the longest path in a real
// flow and is the obvious place to add a pipeline stage (see docs).
...
module requantize #(
    ...
    logic signed [ACC_W+M_W-1:0] prod;
